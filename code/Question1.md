...
## A) Arrests Per Year & More Arrests Nowadays?
...
## Question 2: What’s the perpetrator like? This is usually answered with age, sex, and descent/race.
## By Sex and Descent (Race)
```
SELECT
    sex_code,
    COUNT(*) AS num_arrests
